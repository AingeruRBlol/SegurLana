...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_stmt_prepare($stmt, $sql)) {
        ...
        // Redirige al usuario a la página de perfil o a donde desees después de la actualización.
        header("Location: profile.php?update=success");
        exit();
    }
}

// ... El código HTML para mostrar el formulario de edición y los datos actuales del usuario.
?>
