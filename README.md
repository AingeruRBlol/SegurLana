...
6. Behin aurreko komando amaituta, docker-compose up komandoa exekutatu (aurretik beste edozein Docker prozesu bat aktibatuta izanez, dagokion karpetan sartu eta hau desaktibatu docker-compose down eginez).
